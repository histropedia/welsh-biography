/* Queries used for timeline data and filter values */


// Filter data is the only language independant query
...
// Templates for all language dependant queries
...
function getQueriesForLanguage(lang) {
  ...
  return {
    ...
    filterLabels: labelsQueryTemplate.replace(/{{lang}}/g, lang).replace(/{{fallbackLang}}/g, fallbackLang),
  }
}
